...
capture = cv.VideoCapture("C:/Users/Nathan A.S/Downloads/buku merah.mp4") # mengambil file video dari path OS yang ada di device

lower_HSV = np.array([160, 100, 150]) # set batasan bawah HUE, Saturation, dan value
...
while True: # selama True maka akan looping terus
    ...
    edge = cv.Canny(HSV, 200, 1000) # Mencari batasan atau pinggiran dari sebuah objek dengan Canny edge detection
